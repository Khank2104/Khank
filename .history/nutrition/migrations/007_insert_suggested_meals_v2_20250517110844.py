...
def insert_more_suggested_meals(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nutrition', '006_insert_suggested_meals'),  # Đúng tên migration trước đó
    ]

    operations = [
        migrations.RunPython(insert_more_suggested_meals),
    ]
